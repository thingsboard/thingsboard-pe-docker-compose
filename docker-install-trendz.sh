...
ADDITIONAL_COMPOSE_CITUS_ARGS=$(additionalComposeCitusArgs) || exit $?
...
if [ ! -z "${ADDITIONAL_STARTUP_SERVICES// }" ]; then
    ...
    COMPOSE_ARGS="\
          --env-file ../.env \
          -f docker-compose.yml ${ADDITIONAL_CACHE_ARGS} ${ADDITIONAL_COMPOSE_ARGS} ${ADDITIONAL_COMPOSE_CITUS_ARGS} ${ADDITIONAL_COMPOSE_QUEUE_ARGS} ${ADDITIONAL_COMPOSE_TRENDZ_ARGS} ${ADDITIONAL_COMPOSE_EDQS_ARGS} \
...
COMPOSE_ARGS="\
      --env-file ../.env \
      -f docker-compose.yml ${ADDITIONAL_CACHE_ARGS} ${ADDITIONAL_COMPOSE_ARGS} ${ADDITIONAL_COMPOSE_CITUS_ARGS} ${ADDITIONAL_COMPOSE_QUEUE_ARGS} ${ADDITIONAL_COMPOSE_TRENDZ_ARGS} ${ADDITIONAL_COMPOSE_EDQS_ARGS} ${ADDITIONAL_COMPOSE_TRENDZ_DATABASE_INIT_ARGS} \
